  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <button
          onClick={openAdd}
          className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-[#e0844c] to-[#c94cb0] text-white font-semibold text-sm shadow-md hover:shadow-lg hover:opacity-90 transition-all"
        >
